  ...
  return (
    <>
      <Heading as="h2" size="md">
        {
          {
            FR: "La situation de l'éducation publique au Népal, bien qu'en amélioration, reste compliquée.",
