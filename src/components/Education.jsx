...
export const Education = () => (
  <>
    ...
    <Text>
      ...
      parkings, vendeurs etc. Ils sont alors susceptibles de quitter abruptement
      leur poste pour d&apos;autres opportunités plus lucratives. Notamment pour
      rejoindre les écoles privées qui pullulent dans les villes du pays.
      Celles-ci sont financées par les parents d&apos;élèves et imposent des
      frais importants que les familles défavorisées ne peuvent payer.
      L&apos;éducation y est généralement considérée de meilleure qualité, bien
      que ceci soit un débat au sein de la communauté enseignante népalaise.
      Dans tous les cas, elle y est continue, ce qui constitue un avantage
      considérable dans le contexte du pays. Mais seuls les enfants de familles
      aisées et classes moyennes urbaines peuvent y accéder. Ce double système,
      qui s&apos;auto-entretien, augmente les inégalités sociales préexistantes.
    </Text>
    ...
    <Text>
      ...
      caritative (Tharu Women&apos;s Hands) qui s&apos;efforce, depuis 2017, de
      ...
      l&apos;école maternelle du village (appelé le New Saurah Day Care Center).
      Face aux manques de moyens de sa charité pour à la fois parrainer des
      enfants dans des écoles privées et maintenir l&apos;activité de
