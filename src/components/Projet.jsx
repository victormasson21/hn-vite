  ...
  return (
    <>
      <Text>
        {
          {
            FR: "C'est un projet dont il a fait part à Romain au cours de leur collaboration. Après quelques discussions avec des amis et sa famille, Romain a décidé de créer l'association Horizons Népal en janvier 2023 afin de lever des fonds pour permettre au projet de Sanjay de voir le jour. L'année 2023 a été consacrée à la création de la structure associative en France (statuts, bureau, compte en banque, compte hello asso, site web, etc.). L'idée est de financer cette école de manière privée (à travers des dons), puis semi-privée (en ré-impliquant les pouvoirs publics Népalais) dans un second temps. Ce financement permettrait de maintenir un bon niveau de salaire pour le personnel enseignant et donc une qualité de l'enseignement, tout en fournissant un service gratuit et en priorité aux enfants des familles les plus défavorisées du village.",
      ...
      <Text>
        {
          {
            FR: "Au Népal, le projet a depuis été discuté au niveau communal. Le maire s'est engagé à aider le projet si l'association peut démontrer la durabilité de son action pour les enfants lors de la première phase du projet, sur 3 ans. Cette phase doit financer le premier « étage » de la pyramide éducative de l'école du village. Dans le système éducatif népalais, ce premier étage est constitué de trois niveaux, pour les enfants de 3 à 6 ans. Pour le moment, l’école du village est gérée de manière ad hoc par le New Sauraha Day Care Center en fonction des financements que la charité de Sanjay trouve ainsi que des dons ponctuels qui sont faits par certains parents.",
      ...
      <UnorderedList>
        ...
        <ListItem textAlign="justify">
          <Text>
            {
              {
                FR: "Payer le salaire de 7 membres du personnel (3 professeurs des écoles, 3 assistants d'éducation, un personnel de surface/cantine) qui permettra de faire fonctionner les trois niveaux (1 classe d'environ 30 à 35 élèves par niveau).",
