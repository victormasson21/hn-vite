...
export const Projet = () => (
  <>
    <Text>
      ...
      collaboration. Après quelques discussions avec des ami.es et sa famille,
    ...
    <Text>
      ...
      pyramide éducative de l&apos;école du village. Cette première étape, dans
      le système éducatif népalais, est constitué de trois niveaux, pour les
      enfants de 3 à 5-6 ans. Dans le village, elle est pour le moment gérée par
      le New Sauraha Day Care Center (NSDCC), de manière ad hoc, en fonction des
    ...
    <UnorderedList>
      <ListItem>
        Financer la rénovation des salles du NSDCC, et la construction
        d&apos;une nouvelle salle de classe.
      </ListItem>
      <ListItem>
        Payer le salaire de 7 membres du personnel (3 professeur des écoles, 3
        assistants d »éducation, un personnel de surface/cantine) qui permettra
        de faire fonctionner les trois niveaux (1 classe d&apos;environ 30-35
        élèves par niveau).
      </ListItem>
    </UnorderedList>
  </>
