  ...
  return (
    <>
      <Heading as="h3" size="md">
        {
          {
            FR: "Si la collaboration entre les partenaires népalais et l'association Horizons Népal fonctionne et permet la pérennisation de l’école maternelle sur plus d’une année, une réévaluation du projet est envisagée en 2026.",
            EN: "If the collaboration between the Nepalese partners and the Horizons Nepal association works and allows the sustainability of the nursery school for more than one year, a re-evaluation of the project is envisaged in 2026.",
          }[locale]
        }
      </Heading>
      <Text>
